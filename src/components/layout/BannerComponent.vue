  ...
  <section>
    <b-row id="banner" align-v="center" class="min-vh-100 relative z-1 mt-5">
      ...
      <b-col lg="5" offset-lg="1" align-self="stretch" class="p-5 left-center text-left mt-4 mt-lg-0 min-vh-75">
        <h1 class="site-title font-weight-bold" v-html="title"></h1>
        <h3 class="site-subtitle text-dark my-3" v-html="subtitle"></h3>
        <div>
          <b-button href="#mission" variant="outline-dark" class="cta mr-2" v-html="btn1"></b-button>
          <b-button variant="dark" class="cta" v-html="btn2"></b-button>
        </div>
      </b-col>
